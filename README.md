...
* Option 1 - [Download Cytoscape session file]() for all genes
* Option 2 - [Download Cytoscape session file]() for genes filtered via **transcription factor activity, sequence-specific DNA binding** ([GO:0003700](http://www.informatics.jax.org/vocab/gene_ontology/GO:0003700))
...
* Network image
* Statistics about number of nodes and edges
